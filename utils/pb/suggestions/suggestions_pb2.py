...
if _descriptor._USE_C_DESCRIPTORS == False:
  ...
  _globals['_SUGGESTIONSRESPONSE']._serialized_end=86
  _globals['_SUGGESTIONSSERVICE']._serialized_start=88
  _globals['_SUGGESTIONSSERVICE']._serialized_end=183
